...
func _init(entity:Entity, queue_order:bool = false, operation:Operation = null) -> void:
	...
	self._entity = entity ## Store a reference to the entity for instancing new orders in the operation
...
func process(entity:Entity, delta:float) -> void:
	...
	self._active_order.process(entity, delta)
...
func add_order(order:Order, is_queued:bool = false) -> void:
	...
	if is_queued and self._active_order != null:
		self._order_queue.push_back(order)
	elif self._active_order == null:
